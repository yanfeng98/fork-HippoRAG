...
if __name__ == "__main__":
    print(json.dumps(best_dspy_prompt, indent=2))
    print(f"{'*'*42}")
    print(best_dspy_prompt['prog']['signature']['instructions'])
    print(f"{'*'*42}")
    print(best_dspy_prompt['prog']['system'])
